...
<body> 
	...
	<form method="post" action="Rabbocco">
		<div class="col-md-5 col-md-offset-1">
			<h5><i>Selezionare il barile da cui prelevare</i></h5>
					    ...
					    <tbody>
							...
							<tr>
								<c:forEach var="j" begin="0" end="${c}">
									...
									<td width="11%"> <input class="radio-input" type="radio" name="src" value ="${o[0].getData(i)}"/></td> 
							</tr>
							</c:forEach>
						</tbody>
					</table>
		...
		<div class="col-md-5">
			<h5><i>Selezionare il barile in cui aggiungere</i></h5>
			<div class="table-responsive">
				<table class="table table-striped table-hover table-condensed">
				    <thead>
				        <tr>
				    	 ...
				    	 <c:forEach var="i" begin="0" end="${r}">
							<tr>
								<c:forEach var="j" begin="0" end="${c}">
									...
									<td width="11%"> <input class="radio-input" type="radio" name="dst" value ="${o[0].getData(i)}"/></td> 
							</tr>
						</c:forEach>
					</tbody>
				</table>
		...
		<div class="col-md-5 col-md-offset-3">
			<h5><i>Indica la quantità di prodotto per effettuare il rabbocco</i></h5> 
	        <div class="center"><input class="input-margin form-control" type="text" name="quantita" placeholder="quantità..."/></div>
