...
<body> 
	...
	<form method="post" action="Degustazione" enctype="multipart/form-data">
		<div class="col-md-5 col-md-offset-3">
			<h5><i>Selezionare un barile per cui effettuare la degustazione</i></h5>
	    ...
	    <div class="col-md-5 col-md-offset-3">
			<h5><i>Scegliere un file da associare al barile</i></h5>
	       	<div class="center"><input class="form-control input-margin" name="file" type="file"/></div>
